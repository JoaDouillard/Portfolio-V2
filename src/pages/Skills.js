...
function Skills() {
  ...
  return (
    <div style={{
      minHeight: '100vh',
      height: (window.innerWidth <= 1000 && window.innerHeight <= 1200) ? 'auto' : '100vh',
      background: 'linear-gradient(45deg, #0a0a23 0%, #1a1a3e 25%, #2d1b69 50%, #0a192f 100%)',
      color: '#8892b0',
      fontFamily: 'Consolas, "SF Mono", "Fira Code", "Fira Mono", "Roboto Mono", monospace',
      overflow: (window.innerWidth <= 1000 && window.innerHeight <= 1200) ? 'visible' : 'hidden',
      position: 'relative'
    }}>
      ...
      <header style={{
        ...
        backgroundColor: (window.innerWidth <= 1000 && window.innerHeight <= 1200) || scrolled ? 'rgba(10, 25, 47, 0.95)' : 'transparent',
        backdropFilter: (window.innerWidth <= 1000 && window.innerHeight <= 1200) || scrolled ? 'blur(10px)' : 'none',
        zIndex: 1000
      }}>
        <a href="/" style={{
          color: '#64ffda',
      ...
      <main style={{
        paddingTop: '70px',
        paddingBottom: '60px',
        minHeight: (window.innerWidth <= 1000 && window.innerHeight <= 1200) ? 'calc(100vh - 130px)' : '100vh',
        height: (window.innerWidth <= 1000 && window.innerHeight <= 1200) ? 'auto' : '100vh',
        display: 'flex',
        alignItems: (window.innerWidth <= 1000 && window.innerHeight <= 1200) ? 'flex-start' : 'center',
        justifyContent: 'center'
      }}>
        <div style={{
          width: window.innerWidth <= 768 ? '95%' : 
                window.innerWidth <= 1200 ? '90%' : '90%',
          maxWidth: '1400px',
          height: (window.innerWidth <= 1000 && window.innerHeight <= 1200) ? 'auto' : 'calc(80vh - 100px)',
          display: 'flex',
          flexDirection: window.innerWidth <= 768 ? 'column' : 'row',
          gap: window.innerWidth <= 768 ? '20px' : '30px',
          padding: (window.innerWidth <= 1000 && window.innerHeight <= 1200) ? '20px 0' : '0'
        }}>
          ...
          <div style={{
            ...
            height: window.innerWidth <= 768 ? '400px' : 
                   (window.innerWidth <= 1200 ? '500px' : 'auto'),
            order: window.innerWidth <= 768 ? 0 : 0
          }}>
            <iframe
              src="/assets/images/skills/CV.pdf#toolbar=0&navpanes=0&scrollbar=0&view=FitH"
              style={{
                width: '100%',
                height: '100%',
                border: 'none',
          ...
          <div style={{
            ...
            <div style={{
              ...
              width: '100%',
              minHeight: (window.innerWidth <= 1000 && window.innerHeight <= 1200) ? '300px' : 'auto'
            }}
            onMouseEnter={(e) => {
              ...
              {[
                ...
                <div key={index} style={{ marginBottom: '15px' }}>
                  <div style={{
                    ...
                    <span style={{ color: '#8892b0', fontSize: '0.9rem' }}>{skill.name}</span>
                    <span style={{ color: '#64ffda', fontSize: '0.8rem' }}>{skill.percent}%</span>
                  </div>
                  <div style={{
                    width: '100%',
                    height: '6px',
            ...
            <div style={{
              ...
              transition: 'all 0.3s ease',
              width: '100%',
              minHeight: (window.innerWidth <= 1000 && window.innerHeight <= 1200) ? '250px' : 'auto'
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.borderColor = 'rgba(100, 255, 218, 0.3)';
              e.currentTarget.style.transform = 'translateY(-5px)';
            ...
            >
              ...
              <div style={{ position: 'relative' }}>
                ...
                {/* Timeline items */}
                <div style={{ marginBottom: '25px', paddingLeft: '35px', position: 'relative' }}>
                  <div style={{
                    position: 'absolute',
                    left: '6px',
                    top: '5px',
                  ...
                  <div style={{ color: '#64ffda', fontSize: '0.8rem', marginBottom: '5px' }}>2023-2026</div>
                  <div style={{ color: '#fff', fontSize: '1rem', fontWeight: 'bold' }}>BUT Informatique</div>
                  <div style={{ color: '#8892b0', fontSize: '0.9rem' }}>IUT Clermont Auvergne</div>
                ...
                <div style={{ paddingLeft: '35px', position: 'relative' }}>
                  ...
                  <div style={{ color: '#64ffda', fontSize: '0.8rem', marginBottom: '5px' }}>2022</div>
                  <div style={{ color: '#fff', fontSize: '1rem', fontWeight: 'bold' }}>BAC STI2D</div>
                  <div style={{ color: '#8892b0', fontSize: '0.9rem' }}>Pôle La Chartreuse Paradies</div>
                  <div style={{ color: '#8892b0', fontSize: '0.8rem', marginTop: '5px' }}>
            ...
            <div style={{
              ...
              transition: 'all 0.3s ease',
              width: '100%',
              minHeight: (window.innerWidth <= 1000 && window.innerHeight <= 1200) ? '200px' : 'auto'
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.borderColor = 'rgba(100, 255, 218, 0.3)';
              e.currentTarget.style.transform = 'translateY(-5px)';
            ...
            >
              ...
              <div style={{ marginBottom: '20px' }}>
                <div style={{
                  ...
                  <span style={{ color: '#64ffda', fontSize: '0.8rem' }}>Natif</span>
                </div>
                <div style={{
                  display: 'flex',
                  justifyContent: 'space-between',
                  ...
                  <span style={{ color: '#64ffda', fontSize: '0.8rem' }}>B2 - Avancé</span>
                </div>
                ...
                >
                  <span style={{ color: '#64ffda', fontWeight: 'bold' }}>PIX</span>
                </div>
              </div>
              ...
              <div style={{
                ...
                <a
                  ...
                  style={{
                    ...
                    alignItems: 'center',
                    gap: '6px',
                    padding: window.innerWidth <= 480 ? '10px 15px' : '8px 10px',
                    ...
                    transition: 'all 0.3s ease',
                    flex: window.innerWidth <= 550 ? '1 1 100%' : 
                          window.innerWidth <= 900 ? '1 1 calc(50% - 4px)' : '1 1 auto',
                    justifyContent: 'center',
                ...
                <a
                  ...
                  style={{
                    ...
                    alignItems: 'center',
                    gap: '8px',
                    padding: window.innerWidth <= 480 ? '10px 15px' : '8px 15px',
                    background: 'rgba(100, 255, 218, 0.05)',
                    border: '1px solid rgba(100, 255, 218, 0.2)',
                    borderRadius: '6px',
                    color: '#64ffda',
                    ...
                    transition: 'all 0.3s ease',
                    flex: window.innerWidth <= 550 ? '1 1 100%' : 
                          window.innerWidth <= 900 ? '1 1 100%' : '1 1 auto',
                    justifyContent: 'center',
                    minWidth: 'fit-content'
                  }}
                  onMouseEnter={(e) => {
